...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 2500 zaap, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 2500 zaap - checking if valid masternode)
