...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "zaapNetwork") type = zaapNetwork;
    if(strType == "zaapNetworkVariable") type = zaapNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == zaapNetwork) s = "zaapNetwork";
    if(type == zaapNetworkVariable) s = "zaapNetworkVariable";
