 ...
 *
 *   // network
 *   CzaapNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.zaap.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CzaapNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: zaapNetwork
// //   -- signature requirements : Key1(User)
// class CzaapNetworkVariable : public CGovernanceObject
// {
// private:
