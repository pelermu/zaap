    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("zaap-light"), QVariant("light"));
    ui->theme->addItem(QString("zaap-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("zaap-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("zaap-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("zaap-traditional"), QVariant("trad"));
