    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("zaap Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About zaap Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  zaap-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the zaap in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 zaap, 0.1 zaap, 1 zaap and 10 zaap -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://zaapnetwork.atlassian.net/wiki/display/DOC/PrivateSend\">https://zaapnetwork.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("zaap Core is shutting down...") + "<br /><br />" +
