    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("zaap Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a zaap address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zaap: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About zaap Core"), this);
    aboutAction->setStatusTip(tr("Show information about zaap Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for zaap Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your zaap addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified zaap addresses"));
    ...
    openAction->setStatusTip(tr("Open a zaap: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the zaap Core help message to get a list with possible zaap Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("zaap Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to zaap network", "", count));
    } else {
...
{
    QString strTitle = tr("zaap Core"); // default title
