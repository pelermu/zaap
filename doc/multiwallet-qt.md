...
Only requiring some minor changes is zaap.cpp.
...
Changes to zaap.cpp
----------------------
zaap.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
