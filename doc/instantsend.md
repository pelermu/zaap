...
This mechanism has been integrated into Bitcore-Node-zaap which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zaapnetwork/insight-api-zaap#web-socket-api](https://github.com/zaapnetwork/insight-api-zaap#web-socket-api)
* API: [https://github.com/zaapnetwork/insight-api-zaap#instantsend-transactions](https://github.com/zaapnetwork/insight-api-zaap#instantsend-transactions)
...
By default, the zaap Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the zaap Core daemon:
