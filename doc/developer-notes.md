...
zaap Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 25194.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 25193 for connections and services them.
...
However, in open source software such as zaap Core, where everyone uses
...
pay attention to for reviewers of zaap Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: zaap Core uses tinyformat, which is type safe. Leave them out to avoid confusion
